...
- T9 mounted at `/Volumes/T9`
- T9 currently reports approximately 1.5 TiB available
- A partial `GLM-5.3-Flash` checkpoint exists at `/Volumes/T9/loom-ai-models/models/GLM-5.3-Flash`
- The checkpoint is not yet verified as complete or byte-identical to its upstream source
...
2. **Model gate:** confirm the model directory has every required shard and valid metadata.
